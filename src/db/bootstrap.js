...
async function seedReferences(client) {
  const specialties = [
    ...
    ['141', 'Електроенергетика, електротехніка та електромеханіка', 'Електротехніка'],
    ...
    ['029', 'Інформаційна, бібліотечна та архівна справа', 'Архівна справа'],
  ...
  const groups = [
    ['КН-21', '122'], ['КН-31', '122'], ['КІ-21', '123'], ['КІ-31', '123'], ['ПР-21', '081'],
    ['ЕК-21', '051'], ['ОБ-21', '071'], ['АТ-21', '274'], ['ТТ-21', '275'], ['БЦІ-21', '192'],
    ['ЕМ-21', '141'], ['ФН-21', '072'], ['АР-21', '029']
  ];
